 ...
 *
 * Portal-mounted to document.body so it escapes the pinned viewport's
 * transform context (which would otherwise apply GSAP-set transforms to
 * the modal too).
 *
 * All colors are hardcoded in cinematic.module.css for the .modalShell +
 * children classes — the lesson from Press/Brutalist/spatial-walk: CSS
 * vars defined on the template root don't reach across the portal.
 *
 * Interactions:
 *   - ESC to close
 *   - Backdrop click closes (clicks inside content don't bubble)
 *   - Body scroll locked while open
 *   - SSR mount gate so portal only attempts to mount client-side
 */
